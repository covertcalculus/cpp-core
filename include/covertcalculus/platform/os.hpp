...
namespace covertcalculus::platform {
    class os final {
        CC_DEFINE_PUBLIC_CLASS_METADATA(::covertcalculus::platform, os);
    public:
        os() = delete;
        ...
        class type final {
            CC_DEFINE_PUBLIC_CLASS_METADATA(::covertcalculus::platform::os, type);
        public:
            type() = delete;
            static constexpr auto unknown = result::unknown;
            static constexpr auto windows = result::windows;
            static constexpr auto linux_  = result::linux_;
        ...
        static constexpr bool is_linux()   { return get() == type::linux_;  }
