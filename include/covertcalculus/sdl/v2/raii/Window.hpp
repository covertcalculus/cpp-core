...
#include <covertcalculus/classes/views/nonzero-T.hpp>
...
namespace covertcalculus::sdl::v2::raii {
    class Window
        ...
        , public classes::mixins::crtp::pointers::smart_extensions<Window, SDL_Window, v2::Exception>
    {
        CC_DEFINE_PUBLIC_CLASS_METADATA(::covertcalculus::sdl::v2::raii, Window);
    ...
    private:
        ...
        void _throw_if_bad_(tags::throwing tag) {
            $v().or_throw(tag.string());
        }

    public:
        class Data {
            CC_DEFINE_PUBLIC_CLASS_METADATA(::covertcalculus::sdl::v2::raii::Window, Data);
        public:
